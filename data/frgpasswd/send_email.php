...
if ($username !== false) {
    ...
    $resetLink = "https://futureradio.net/data/frgpasswd/reset_password.php?token=" . $resetToken . "&user=" . urlencode($username);
    $subject = '"Future Radio Password Reset"';

    $command = "echo 'Hello $username. \nWe have received a request to reset your password. Please use the link below to set a new password. This link will expire in 1 hour. \n\nReset Link: $resetLink\n\n If you did not request a password reset please email futureradioservices@gmail.com and open a ticket.' | mail -s $subject $userEmail";
